...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
        ...
        <img src="../public/dist/img/logomixi.jpg"  alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="padding-left: 5px;">
              <span  class="brand-text font-weight-light">CCQ2111G<BR/> VÀ LỚP HỌC LẠI LTW</span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img  src="../public/dist/img/refund.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="index.php" class="d-block">MIXIGAMING</a>
        </div>
      </div>
