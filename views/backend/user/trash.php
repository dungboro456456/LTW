    ...
    <table class="table table-bordered table-hover table-striped"> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td><img class="img-thumbnail" src="../public/dist/img/user/<?php echo $row['image'] ?>" alt=""></td> 
                <td><?=$row['name']?></td> 
                <td><?=$row['slug']?></td> 
                <td><?=$row['created_at']?></td> 
                <td>
                              <a class="btn btn-sm btn-info p-3 mr-2" style="border-radius: 17%"; href="index.php?option=user&cat=restore&id=<?=$row['id'];?>"> 
                              <i class="fa-solid fa-rotate-left"></i>
                              </a>
                              <a class="btn btn-sm btn-danger p-3 mr-2" style="border-radius: 17%"; href="index.php?option=user&cat=destroy&id=<?=$row['id'];?>"> 
