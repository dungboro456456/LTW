...
<div class="card"> 
  ...
  <div class="card-body"> 
    <table class="table table-bordered table-hover table-striped"> 
                        ...
                        <div class="col-md-5">
                        <div class="col-md-7">
                        <h2>Tên sản phẩm:<?=$user['name']?></h2>
                        <p><strong>ID sản phẩm: <?=$user['id']?></strong></p>
                        <p><strong>Slug:<?=$user['price']?></strong></p>
                        <p><strong>Mã cấp cha:<?=$user['price']?></strong></p>
                        <p><strong>Từ khóa (SEO):<?=$user['price']?></strong></p>
                        ...
                        <h3><strong>Mô tả sản phẩm:</strong><?=$user['metadesc']?></h3>
