  ...
  <div class="row">
    <div class="col-md-6">
        <div class="form-group"> 
          ...
          <input type="name" value="<?=$product['name']?>" class="form-control" id="name" name="name" require placeholder="VD:Quần áo">
        </div>
        <div class="form-group">
          <label for="metadesc">Mô tả(SEO):</label>
          <textarea class="form-control" id="metadesc" name="metadesc" require placeholder="VD:Thời trang nam đẹp số dách, đẹp hơn Sơn Tùng, chấp tùng núi, chấp sếp 3 bước "><?=$product['metadesc']?></textarea>
        </div>
        <div class="form-group">
          <label for="metakey">Từ khóa(SEO):</label>
          <input type="text" class="form-control" value="<?=$product['metakey']?>" id="metakey" name="metakey" require placeholder="VD:Thời trang nam">
        </div>
        <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <option value="1"<?php ($product->status==1)? 'selected': ''; ?>>Chưa bật</option>
          <option value="2"<?php ($product->status==2)? 'selected': ''; ?>>Đẫ bật</option>
          </select>
          </div>
          </div>
          </div>
          ...
          <a class="btn btn-sm btn-info p-3 m-2" style="border-radius: 17%"; href="index.php?option=product&cat=detail&id=<?=$product['id'];?>"> 
